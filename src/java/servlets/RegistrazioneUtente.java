...
public class RegistrazioneUtente extends HttpServlet {
    //private static final Logger logger = LogManager.getLogger(RegistrazioneUtente.class);
    /**
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try{
            ...
            ud.registration(user, cm);
            //logger.info("registrazione eseguita");
            request.getSession().setAttribute("msgok", "Utente inserito correttamente");
